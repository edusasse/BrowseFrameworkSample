...
public class TipoEnderecoDAOHibernateImpl extends CrudDAOHibernateImpl<Long, TipoEndereco> implements TipoEnderecoDAO {

	@Autowired
	public TipoEnderecoDAOHibernateImpl(@Qualifier("sessionFactory") SessionFactory sessionFactory) {
