...
public class PerfilDAOHibernateImpl extends CrudDAOHibernateImpl<Long, Perfil> implements PerfilDAO {

	@Autowired
	public PerfilDAOHibernateImpl(@Qualifier("sessionFactory") SessionFactory sessionFactory) {
