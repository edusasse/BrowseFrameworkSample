...
@Repository(value = "pessoaFisicaDAO")
public class PessoaFisicaDAOHibernateImpl extends CrudDAOHibernateImpl<Long, PessoaFisica> implements PessoaFisicaDAO {

	@Autowired
	public PessoaFisicaDAOHibernateImpl(@Qualifier("sessionFactory") SessionFactory sessionFactory) {
